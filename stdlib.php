  ...
  function drawModal($database, $type) {
    ...
    if($type == 'trips') {
      echo("<input type='text' class='form-control' placeholder='Trip name' required='True' autofocus='' name='tripName'><br>
            ...
            <input type='text' class='form-control' id='datetimepicker1' placeholder='Start date' />
             
             <br>
             
             <input type='text' class='form-control' id='datetimepicker2' placeholder='End date' />
      ...
      echo("<input type='hidden' name='tripNo' value='$_GET[id]'>
            ...
            <input type='text' class='form-control' id='datetimepicker3' placeholder='Start date' />
             
             <br>
             
             <input type='text' class='form-control' id='datetimepicker4' placeholder='End date' />
             <input type='hidden' name='confirmed' value='False'>");
